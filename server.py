...
ALIPAY_APP_PRIVATE_KEY = _load_pem_key(os.getenv("ALIPAY_APP_PRIVATE_KEY", ALIPAY_DEFAULT_PRIVATE_KEY))
ALIPAY_PUBLIC_KEY = _load_pem_key(os.getenv("ALIPAY_PUBLIC_KEY", ALIPAY_DEFAULT_PUBLIC_KEY))
